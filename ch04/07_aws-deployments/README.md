...
Other alternative deployment strategies available through Grunt include, but are _clearly not limited to_, [sftp](https://github.com/thrashr888/grunt-sftp-deploy), [ssh](https://github.com/andrewrjones/grunt-ssh), [rsync](https://github.com/jedrichards/grunt-rsync), and Heroku, as we saw earlier, in [**ch04e05** Heroku Deployments](https://github.com/bevacqua/buildfirst/tree/master/ch04/05_heroku-deployments "Heroku Deployments").
